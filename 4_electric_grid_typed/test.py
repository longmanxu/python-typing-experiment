...
def make_power_source() -> electric_grid.ElectricGrid:
...
def create_power_source(source_type: str) -> power_source.PowerSource:
...
def test_old_nuclear_power_plant_id() -> None:
